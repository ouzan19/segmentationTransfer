...
{
	loadOff2(filename.c_str());
}

void Mesh::loadxyz(std::string filename)
{
	loadxyz2(filename.c_str());
}

void Mesh::loadOff2(const char* meshFile)
{
...
void Mesh::loadxyz2(const char* fName){
